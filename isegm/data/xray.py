...
class XrayDataset(ISDataset):
    ...
    def get_sample(self, index):
        ...
        # image_path = self._split_path / image_filename
        image_path =  self.dataset_path / 'restricted' / image_filename
        ...
        for indx, obj_annotation in enumerate(image_annotations):
            ...
            category = obj_annotation['category_id']
            #prob = 1.1 if category == 2 else 1
            prob = 1
            object_mask = mask > 0
