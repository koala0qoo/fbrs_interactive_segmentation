...
from isegm.data.xray import XrayDataset
...
def init_model(cfg):
    ...
    model = get_deeplab_model(backbone='resnet50', deeplab_ch=128, aspp_dropout=0.20, norm_radius=180)
...
def train(model, cfg, model_cfg, start_epoch=0):
    ...
    trainset = XrayDataset(
        ...
        # samples_scores_path='./models/xray/xray_samples_weights.pkl',
    ...
    lr_scheduler = partial(torch.optim.lr_scheduler.MultiStepLR,
                           milestones=[50, 80, 100], gamma=0.1)
